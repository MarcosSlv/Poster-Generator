...
exports.generateComboPoster = exports.generateSmallPoster = exports.generateBigPoster = void 0;
...
const sheetValidation_1 = require("../services/sheetValidation");
const POSTER_KINDS = {
    big: { tamanho: "cartaz-grande", requiredFields: sheetValidation_1.REQUIRED_FIELDS.default, label: "grande" },
    small: { tamanho: "cartaz-pequeno", requiredFields: sheetValidation_1.REQUIRED_FIELDS.default, label: "pequeno" },
    combo: { tamanho: "cartaz-combo", requiredFields: sheetValidation_1.REQUIRED_FIELDS.combo, label: "combo" }
};
const buildPdfPath = () => {
...
const createPosterHandler = ({ tamanho, requiredFields, label }) => (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const validation = (0, sheetValidation_1.validateSheet)(sheet, requiredFields);
        if (!validation.ok) {
