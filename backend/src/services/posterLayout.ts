...
} satisfies Record<string, Record<string, TextSpec>>;

export const COMBO_POSTER = {
...
export const STACK_MARGINS = {
  big: [0, 0, 0, 20],
  small: [0, 0, 0, 20],
  combo: [0, 0, 0, 25]
} satisfies Record<string, [number, number, number, number]>;

export const COMBO_SELO = "10ZÃO";
export const COMBO_PRECO = "10,00";
